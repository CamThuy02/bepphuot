! function(e) {
    ...
    e.fn.meanmenu = function(n) {
        ...
        return this.each(function() {
            ...
            w || jQuery(window).resize(function() { t = window.innerWidth || document.documentElement.clientWidth, S(), o >= t ? (b(), A()) : S() }), jQuery(window).resize(function() { t = window.innerWidth || document.documentElement.clientWidth, w ? (A(), o >= t ? !1 === M && b() : S()) : (S(), o >= t && (b(), A())) }), b()
        })
    }
}(jQuery);