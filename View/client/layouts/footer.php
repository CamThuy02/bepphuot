                    ...
                    <div class="row">
                        <div class="col-12 text-center">
                            ...
                            <ul class="footer-social">
                                ...
                                <li><a href="#" title="Tuyển dụng">Tuyển dụng</a>
                                </li>
                                <li>
    ...
    <!-- Nivo slider js -->
    <script src="Public\client\vendor\slider\js\jquery.nivo.slider.js" type="text/javascript"></script>
    <script src="Public\client\vendor\slider\home.js" type="text/javascript"></script>
    <!-- Isotope js -->
    ...
    <!-- Ticker Js -->
    <script src="Public\client\js\ticker.js" type="text/javascript"></script>
    <!-- Custom Js -->
