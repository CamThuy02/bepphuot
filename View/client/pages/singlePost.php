                           ...
                           <div class="position-relative img-overlay-70">
                            ...
                            ?>
                               <?php 
                                  foreach ($HeaderPost as $headerpost){
                                ?>
                               <img src="Public/admin/assets/img/<?php echo $singlepost['Img'] ?>" alt=""
                                   class="img-fluid">

                               <div class="topic-box-top-sm">
                                   <div class="topic-box-sm color-cinnabar mb-20">
                                       <?php echo $headerpost['CategoryName'] ?></div>
                               </div>
                                   ...
                                   <ul class="post-info-light mb-10">
                                       <li>
                                           <a href="#" class="title-semibold-light">
                                               <i class="title-semibold-light fa fa-calendar"
                                                   aria-hidden="true"></i><?php echo $singlepost['DatePost']?></a>
                                       </li>
                                   </ul>
                                   <h2 style="color: white" class="title-semibold-light size-c34 mb-40">
                                       <?php echo $singlepost['Title']?></h2>
                               </div>
                               <?php } ?>
                               <?php }?>
                           </div>
                           ...
                           <div class="row item-box-light-lg no-gutters divider">
                               <div class="col-lg-6 col-md-6 col-sm-6 col-6">
                                ...
                                ?>
                                   <a style="font-size:20px; color:red;"
                                       href="?controller=singlePost&PostId=<?php echo $singlepost['PostId']?>"
                                       class="prev-article">
                               ...
                               <div class="col-lg-6 col-md-6 col-sm-6 col-6 text-right">
                                ...
                                ?>
                                   <a style="font-size:20px; color:red;"
                                       href="?controller=singlePost&PostId=<?php echo $singlepost['PostId']?>"
                                       class="next-article">Bài viết tiếp theo
