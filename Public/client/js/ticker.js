! function(e) {
    e.fn.ticker = function(t) {
        ...
        return this.each(function() {
            function t(e) { var t, o = 0; for (t in e) e.hasOwnProperty(t) && o++; return o }
            ...
            function s() {
                if (0 == f.contentLoaded)
                    if (o.ajaxFeed) "xml" == o.feedType ? e.ajax({
                        ...
                        e(n + " LI").each(function(t) { f.newsArr["item-" + t] = { type: o.titleText, content: e(this).html() } })
                    }
            }
            ...
            function c() {
                ...
                e(f.dom.revealID).css(o.direction, t + "px"), "fade" == o.displayType ? e(f.dom.revealID).hide(0, function() { e(f.dom.contentID).css(o.direction, t + "px").fadeIn(o.fadeInSpeed, m) }) : "scroll" == o.displayType || e(f.dom.revealElem).show(0, function() { e(f.dom.contentID).css(o.direction, t + "px").show(), contentWindowSize = e(f.dom.tickerID).width() - e(f.dom.titleID).width() - 20, e(f.dom.contentID).width() <= contentWindowSize ? (animationAction = "right" == o.direction ? { marginRight: distance + "px" } : { marginLeft: distance + "px" }, e(f.dom.revealID).css("margin-" + o.direction, "0px").delay(20).animate(animationAction, time, "linear", m)) : (delay_scroll = contentWindowSize / o.speed, time_scroll = e(f.dom.contentID).width() / o.speed - delay_scroll, animationAction = "right" == o.direction ? { marginRight: contentWindowSize - 7 + "px" } : { marginLeft: contentWindowSize - 7 + "px" }, e(f.dom.revealID).css("margin-" + o.direction, "0px").delay(20).animate(animationAction, delay_scroll, "linear"), scrollSize = e(f.dom.titleID).width() + 20 - e(f.dom.contentID).width() + contentWindowSize, animationAction_scroll = "right" == o.direction ? { right: scrollSize + "px" } : { left: scrollSize + "px" }, e(f.dom.contentID).delay(delay_scroll).animate(animationAction_scroll, time_scroll, "linear", m)) })
            }
    ...
    }, e.fn.ticker.defaults = { speed: .05, ajaxFeed: !1, feedUrl: "", feedType: "xml", displayType: "reveal", htmlFeed: !0, debugMode: !0, controls: !1, direction: "ltr", pauseOnItems: 3e3, fadeInSpeed: 600, fadeOutSpeed: 300 }, e("#sample").ticker()
}(jQuery);