! function(e) {
    ...
    }), e("#wrapper").on("click", "#side-menu-trigger a.menu-times", function(a) { a.preventDefault(); var t = e(this); return e("#offcanvas-body-wrapper").attr("style", ""), t.prev(".menu-bar").removeClass("open"), t.addClass("close"), o(), !1 }), e("#wrapper").on("click", "#offcanvas-nav-close a", function(e) { return o(), !1 }), e(document).on("click", "#wrapper.open .offcanvas-mask", function() { o() }), e(document).on("keyup", function(e) { 27 === e.which && (e.preventDefault(), o()) }), e("#archive-search select.select2").length && e("#archive-search select.select2").select2({ theme: "classic", dropdownAutoWidth: !0, width: "100%" }), e(window).on("load", function() {
        e("#preloader").fadeOut("slow", function() { e(this).remove() });
        var a = e(".ne-isotope");
    ...
    var s = e("#accordion");
    s.children(".panel").children(".panel-collapse").each(function() { e(this).hasClass("in") && e(this).parent(".panel").children(".panel-heading").addClass("active") }), s.on("show.bs.collapse", function(a) { e(a.target).prev(".panel-heading").addClass("active") }).on("hide.bs.collapse", function(a) { e(a.target).prev(".panel-heading").removeClass("active") });
    var i = e("#contact-form");
    i.length && i.validator().on("submit", function(a) {
        var t = e(this),
            n = i.find(".form-response");
        if (!a.isDefaultPrevented()) return e.ajax({ url: "vendor/php/contact-form-process.php", type: "POST", data: i.serialize(), beforeSend: function() { n.html("<div class='alert alert-info'><p>Loading ...</p></div>") }, success: function(e) { "success" === e ? (t[0].reset(), n.html("<div class='alert alert-success'><p>Message has been sent successfully.</p></div>")) : n.html("<div class='alert alert-success'><p>" + e + "</p></div>") } }), !1;
        ...
        var e = { mapTypeControlOptions: { mapTypeIds: ["Styled"] }, center: new google.maps.LatLng(-37.81618, 144.95692), zoom: 11, disableDefaultUI: !0, mapTypeId: "Styled" },
            ...
            n = (new google.maps.Marker({ position: t.getCenter(), animation: google.maps.Animation.BOUNCE, icon: "img/map-marker.png", map: t }), new google.maps.StyledMapType([{ featureType: "water", elementType: "geometry.fill", stylers: [{ color: "#b7d0ea" }] }, { featureType: "road", elementType: "labels.text.fill", stylers: [{ visibility: "off" }] }, { featureType: "road", elementType: "geometry.stroke", stylers: [{ visibility: "off" }] }, { featureType: "road.highway", elementType: "geometry", stylers: [{ color: "#c2c2aa" }] }, { featureType: "poi.park", elementType: "geometry", stylers: [{ color: "#b6d1b0" }] }, { featureType: "poi.park", elementType: "labels.text.fill", stylers: [{ color: "#6b9a76" }] }], { name: "Styled" }));
